package org.example.autoreview.global.aspect;
...
public class LoggingAspect {
    ...
    private static final List<Class<? extends Annotation>> MAPPING_CLASSES = List.of(
    ...
    public void logRequest(JoinPoint joinPoint) {
        final Map<String, Object> params = extractParameters(joinPoint);
        ...
        try{
            log.info("[HTTP Request] {}, params={}", requestUrl, objectMapper.writeValueAsString(params));
    ...
    private String getRequestUrl(Method method, Class<? extends Annotation> mappedAnnotation, String baseUrl){
        ...
        try{
            ...
            final String httpMethod = mappedAnnotation.getSimpleName();
    ...
    private Map<String, Object> extractParameters(JoinPoint joinPoint) {
        ...
        for (int i = 0; i < numOfParameters; i++) {
            params.put(parameterNames[i], joinPoint.getArgs()[i]);
        }

        return params;
    }

    @AfterReturning(value = "controllerPointcut()", returning = "responseEntity")
